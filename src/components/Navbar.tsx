...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-[100] px-4 md:px-6 py-6 md:py-8">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-base md:text-lg font-bold tracking-tighter leading-none text-white">{siteConfig.name}-</span>
      ...
      >
        {[...navItems, { label: 'Contato', href: '#contato' }].map((item, i) => (
          <motion.a
            key={item.label}
            href={item.href}
