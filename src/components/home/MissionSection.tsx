      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div className="absolute -bottom-6 md:-bottom-12 -right-4 md:-right-12 glass-dark p-4 md:p-8 rounded-2xl md:rounded-3xl z-20 animate-float">
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm md:text-base font-bold text-white">Lubango, Huíla</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-7xl font-black mb-8 md:mb-12 leading-[0.9] tracking-tighter uppercase italic text-white">Elias Licoji <br className="hidden md:block" /> Cacoma</h2>
            <div className="space-y-6 md:space-y-8 text-white/60 text-base md:text-lg leading-relaxed font-light">
              <p>
                No coração de Angola, em meio às paisagens majestosas da Huíla, ecoa uma voz que não se cala. Elias Licoji Cacoma não apenas prega; ele vive a missão que Jesus Cristo confiou a cada um de nós.
              </p>
              <p>
