        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6">
          ...
          >
            ...
            <div className="absolute bottom-8 md:bottom-12 left-8 md:left-12 right-8 md:right-12">
              ...
              <button className="flex items-center gap-3 text-[10px] md:text-xs uppercase tracking-[0.2em] font-black text-white hover:text-secondary transition-colors">
          ...
          >
            ...
            <div>
              ...
              <button className="w-full py-3 md:py-4 glass-light rounded-2xl text-[8px] md:text-[10px] uppercase tracking-[0.2em] font-black text-white hover:bg-white hover:text-black transition-all">
                Abrir Hinário
              </button>
            </div>
          </motion.div>
