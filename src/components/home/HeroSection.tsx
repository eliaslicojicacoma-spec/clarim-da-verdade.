...
export function HeroSection() {
  ...
  const mission = "Pregar o evangelho como missão que Jesus Cristo nos deixou.";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 text-center">
        ...
        >
          ...
          <p className="text-base md:text-2xl text-white/60 max-w-2xl mx-auto font-light leading-relaxed mb-12 md:mb-16">
            ...
            <span className="text-white/40 italic text-sm md:text-base">Lubango, Huíla — Angola</span>
          </p>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8">
            <button className="w-full md:w-auto group relative px-10 md:px-12 py-4 md:py-5 bg-white text-black font-black uppercase tracking-[0.2em] text-[10px] md:text-xs rounded-full overflow-hidden transition-all hover:scale-105">
