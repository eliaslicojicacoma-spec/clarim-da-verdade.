        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-12 md:mb-16">
            <div className="p-8 md:p-12 glass-light rounded-[2rem] md:rounded-[3rem] border border-white/10 hover:border-secondary/40 transition-all group">
              ...
              <div className="text-base md:text-xl font-mono font-bold text-secondary mb-6 md:mb-8 break-all">{contact.pix}</div>
              <button className="flex items-center gap-3 mx-auto text-[8px] md:text-[10px] uppercase tracking-[0.2em] font-black text-white/60 group-hover:text-white">
                <Copy size={14} /> Copiar Chave
              </button>
            </div>
            <div className="p-8 md:p-12 glass-light rounded-[2rem] md:rounded-[3rem] border border-white/10 hover:border-secondary/40 transition-all group">
              <h4 className="text-[10px] uppercase tracking-[0.3em] font-black text-white/40 mb-4 md:mb-6">PayPal</h4>
              <div className="text-base md:text-xl font-mono font-bold text-secondary mb-6 md:mb-8 break-all">{contact.paypal}</div>
              <button className="flex items-center gap-3 mx-auto text-[8px] md:text-[10px] uppercase tracking-[0.2em] font-black text-white/60 group-hover:text-white">
