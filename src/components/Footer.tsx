      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="flex gap-6 md:gap-8">
                <a href={contact.facebook} target="_blank" rel="noopener noreferrer" className="w-12 h-12 md:w-16 md:h-16 rounded-full glass-dark flex items-center justify-center text-white hover:bg-white hover:text-black transition-all">
                  <Facebook className="w-5 h-5 md:w-6 md:h-6" />
                </a>
                <a href={contact.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 md:w-16 md:h-16 rounded-full glass-dark flex items-center justify-center text-white hover:bg-white hover:text-black transition-all">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-10 md:pt-12 border-t border-white/5 gap-6 md:gap-8">
          <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4">
            <span className="text-[8px] md:text-xs font-black uppercase tracking-[0.4em] text-white/20">© {new Date().getFullYear()} {siteConfig.name}-</span>
            <div className="w-1 h-1 bg-white/10 rounded-full hidden md:block"></div>
            <span className="text-[8px] md:text-xs font-black uppercase tracking-[0.4em] text-white/20">{siteConfig.location}</span>
          </div>
